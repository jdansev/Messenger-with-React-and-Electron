...
var GoManager = /** @class */ (function () {
    ...
    GoManager.prototype.loadHubs = function () {
        ...
        ajax({
            ...
            .pipe(map(function (r) { return r.response; }), tap(function (x) { return tabManager.emptyHubList(); }), mergeMap(function (s) { return __spreadArrays(s); }), map(function (h) { return decodeUserHub(h); }))
    ...
    GoManager.prototype.loadHubMessages = function (hub_id) {
        ...
        }), mergeMap(function (s) { return __spreadArrays(s); }), map(function (m) { return decodeMessage(m); }))
    ...
    GoManager.prototype.loadFriends = function () {
        ajax({
            ...
            .pipe(map(function (r) { return r.response; }), tap(function (x) { return tabManager.emptyFriendList(); }), mergeMap(function (s) { return __spreadArrays(s); }), map(function (u) { return decodeUser(u); }))
