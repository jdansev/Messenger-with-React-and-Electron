class GradientFactory {
    ...
    public generate(opts: any) {
        ...
        for (var x = 0; x < this.colorStops; x++) {
            pOffset = parseFloat(String(x)) / this.colorStops;
            for (var y = 0; y < len; y++) {
